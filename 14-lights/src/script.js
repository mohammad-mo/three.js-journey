...
const directionalLights = new THREE.DirectionalLight(0x00fffc, 0.3)
directionalLights.position.set(1, 0.25, 0)
...
const spotLight = new THREE.SpotLight(0x78ff00, 1, 6, Math.PI * 0.1, 0.1, 1)
