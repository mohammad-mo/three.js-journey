...
const flirefliesCount = 30
const positionArray = new Float32Array(flirefliesCount * 3)
const scaleArray = new Float32Array(flirefliesCount)

for(let i = 0; i < flirefliesCount; i++)
{
